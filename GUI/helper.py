...
class Numpad(ctk.CTkToplevel):
    def __init__(self, input_field, input_type):
        super().__init__()
        ...
        self.value_display = ctk.CTkEntry(self)
        self.value_display.grid(row=0, column=0, columnspan=4, sticky="news", padx=5, pady=5)
        self.value_display.insert(0, self.input_field.get())

        self.button_1 = ctk.CTkButton(self, text="1", command=lambda: self.add_digit(1))
        self.button_1.grid(row=1, column=0, sticky="news", padx=5, pady=5)

        self.button_2 = ctk.CTkButton(self, text="2", command=lambda: self.add_digit(2))
        self.button_2.grid(row=1, column=1, sticky="news", padx=5, pady=5)

        self.button_3 = ctk.CTkButton(self, text="3", command=lambda: self.add_digit(3))
        self.button_3.grid(row=1, column=2, sticky="news", padx=5, pady=5)

        self.button_4 = ctk.CTkButton(self, text="4", command=lambda: self.add_digit(4))
        self.button_4.grid(row=2, column=0, sticky="news", padx=5, pady=5)

        self.button_5 = ctk.CTkButton(self, text="5", command=lambda: self.add_digit(5))
        self.button_5.grid(row=2, column=1, sticky="news", padx=5, pady=5)

        self.button_6 = ctk.CTkButton(self, text="6", command=lambda: self.add_digit(6))
        self.button_6.grid(row=2, column=2, sticky="news", padx=5, pady=5)

        self.button_7 = ctk.CTkButton(self, text="7", command=lambda: self.add_digit(7))
        self.button_7.grid(row=3, column=0, sticky="news", padx=5, pady=5)

        self.button_8 = ctk.CTkButton(self, text="8", command=lambda: self.add_digit(8))
        self.button_8.grid(row=3, column=1, sticky="news", padx=5, pady=5)

        self.button_9 = ctk.CTkButton(self, text="9", command=lambda: self.add_digit(9))
        self.button_9.grid(row=3, column=2, sticky="news", padx=5, pady=5)

        self.button_0 = ctk.CTkButton(self, text="0", command=lambda: self.add_digit(0))
        self.button_0.grid(row=4, column=0, columnspan=2, sticky="news", padx=5, pady=5)

        if self.input_type == "float":
            self.button_comma = ctk.CTkButton(self, text=",", command=lambda: self.add_digit(","))
            self.button_comma.grid(row=4, column=2, sticky="news", padx=5, pady=5)
        elif self.input_type == "time":
            self.button_colon = ctk.CTkButton(self, text=":", command=lambda: self.add_digit(":"))
            self.button_colon.grid(row=4, column=2, sticky="news", padx=5, pady=5)

        self.button_delete = ctk.CTkButton(self, text="\u2190", command=self.remove_digit)
        self.button_delete.grid(row=1, column=3, rowspan=2, sticky="news", padx=5, pady=5)

        self.button_enter = ctk.CTkButton(self, text="ENTER", command=self.enter)
        self.button_enter.grid(row=3, column=3, rowspan=2, sticky="news", padx=5, pady=5)
